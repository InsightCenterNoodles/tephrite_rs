...
/// Current active combo box, holding payloads, etc
#[derive(Debug)]
struct ActiveCombo {
    root: Entity,
    arrow: Entity,
...
/// Handle the population of combo boxes
...
/// Handle messages that populate the radial combo box.
...
#[inline]
fn select_from_angle(
    transform: GlobalTransform,
    combo_transform: GlobalTransform,
    option_angles: &[f32],
) -> Selection {
    // let up = transform.up();

    // combo_transform.forward();
